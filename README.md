...
<img src="https://img.shields.io/badge/Contributions-Welcome-278ea5" alt="Contrib"/>  ![Stars](https://img.shields.io/github/stars/yc-cui/Pansharpening-Zoo) 
<img src="https://img.shields.io/badge/Survey-8-FF6F00" alt="Survey"/>  <img src="https://img.shields.io/badge/Supervised-34-FF6F00" alt="Supervised"/> <img src="https://img.shields.io/badge/Unsupervised-13-FF6F00" alt="Unsupervised"/>  
...
- `[GRSM 2022]`  [[paper]](https://ieeexplore.ieee.org/document/9844267/) [code] L. Deng et al., “**Machine Learning in Pansharpening: A benchmark, from shallow to deep networks,” IEEE Geoscience and Remote Sensing Magazine**,” *<ins> IEEE Geoscience and Remote Sensing Magazine</ins>*,  vol. 10, no. 3, pp. 279–315, 2022, doi: 10.1109/MGRS.2022.3187652.


- `[J-STARS 2021]`  [[paper]](https://ieeexplore.ieee.org/document/9447896) [code] G. Vivone, M. Dalla Mura, A. Garzelli, and F. Pacifici, “**A Benchmarking Protocol for Pansharpening: Dataset, Preprocessing, and Quality Assessment**,” *<ins> IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing</ins>*, vol. 14, pp. 6102–6118, 2021, doi: 10.1109/JSTARS.2021.3086877

- `[GRSM 2021]`  [[paper]](https://ieeexplore.ieee.org/document/9082183) [code] X. Meng et al., “**A Large-Scale Benchmark Data Set for Evaluating Pansharpening Performance: Overview and Implementation**,” *<ins> IEEE Geoscience and Remote Sensing Magazine</ins>*, vol. 9, no. 1, pp. 18–52, 2021, doi: 10.1109/MGRS.2020.2976696

- `[GRSM 2020]`  [[paper]](https://ieeexplore.ieee.org/document/9245579/) [code] G. Vivone et al., “**A New Benchmark Based on Recent Advances in Multispectral Pansharpening: Revisiting Pansharpening With Classical and Emerging Pansharpening Methods**,” *<ins> IEEE Geoscience and Remote Sensing Magazine</ins>*,  vol. 9, no. 1, pp. 53–81, 2021, doi: 10.1109/MGRS.2020.3019315

- `[ISPRS J P&RS 2020]`  [[paper]](https://linkinghub.elsevier.com/retrieve/pii/S0924271620303002) [code] F. Dadrass Javan, F. Samadzadegan, S. Mehravar, A. Toosi, R. Khatami, and A. Stein, “**A review of image fusion techniques for pan-sharpening of high-resolution satellite imagery**,” *<ins> ISPRS Journal of Photogrammetry and Remote Sensing</ins>*,  vol. 171, pp. 101–117, 2021, doi: https://doi.org/10.1016/j.isprsjprs.2020.11.001

- `[INFORM FUSION 2022]`  [[paper]](https://linkinghub.elsevier.com/retrieve/pii/S1566253522001518) [code] S. Karim, G. Tong, J. Li, A. Qadir, U. Farooq, and Y. Yu, “**Current advances and future perspectives of image fusion: A comprehensive review**,” *<ins>  Information Fusion</ins>*, vol. 90, pp. 185–217, 2023, doi: https://doi.org/10.1016/j.inffus.2022.09.019.

- `[INFORM FUSION 2021]`  [[paper]](https://linkinghub.elsevier.com/retrieve/pii/S1566253521001342) [code] H. Zhang, H. Xu, X. Tian, J. Jiang, and J. Ma, “**Image fusion meets deep learning: A survey and perspective**,” *<ins>  Information Fusion</ins>*, vol. 76, pp. 323–336, 2021, doi: https://doi.org/10.1016/j.inffus.2021.06.008.

- `[INFORM FUSION 2019]`  [[paper]](https://linkinghub.elsevier.com/retrieve/pii/S1566253517306036) [code] X. Meng, H. Shen, H. Li, L. Zhang, and R. Fu, “**Review of the pansharpening methods for remote sensing images based on the idea of meta-analysis: Practical discussion and challenges**,” *<ins>  Information Fusion</ins>*, vol. 46, pp. 102–113, 2019, doi: https://doi.org/10.1016/j.inffus.2018.05.006.
